...
const Body = () => {
    ...
    return (
        <div className="flex gap-4">
            ...
            <div className="flex flex-wrap gap-6 justify-center items-center py-14 mx-auto min-w-full min-h-full bg-gradient-to-r from-yellow-200 via-yellow-400 to-yellow-700">
                {
