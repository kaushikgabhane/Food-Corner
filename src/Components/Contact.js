...
const Contact = () => {
  ...
  return (
    <div className='h-screen flex flex-col justify-center items-center gap-10 pt-5 bg-gradient-to-r from-yellow-200 via-yellow-400 to-yellow-700'>
      ...
      <a href='https://github.com/kaushikgabhane' target='_blank'  rel="noopener noreferrer" className='flex gap-5 items-center'>
      ...
      <a href='https://twitter.com/KaushikGabhane' target='_blank'  rel="noopener noreferrer" className='flex gap-5 items-center'>
      ...
      <a href='https://kaushik543.hashnode.dev/' target='_blank'  rel="noopener noreferrer" className='flex gap-5 items-center'>
